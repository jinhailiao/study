 ...
 * $Header: /cvsroot/HDJS/source/cfgfile/confuse/lexer.c,v 1.1 2009/11/15 04:38:24 cvsadmin Exp $
 */
...
#define yy_set_interactive(is_interactive) { if ( ! yy_current_buffer ) yy_current_buffer = yy_create_buffer( yyin, YY_BUF_SIZE ); yy_current_buffer->yy_is_interactive = is_interactive; }

#define yy_set_bol(at_bol) { if ( ! yy_current_buffer ) yy_current_buffer = yy_create_buffer( yyin, YY_BUF_SIZE ); yy_current_buffer->yy_at_bol = at_bol; }
 ...
 *
 * $Id: lexer.c,v 1.1 2009/11/15 04:38:24 cvsadmin Exp $
 *
